...
class Classifier:
	...
	def toGenericObject(self):
		o = {
			...
			"specifiedAttList": copy.deepcopy(self.specifiedAttList),
			...
			"numerosity": copy.deepcopy(self.numerosity),
			"aveMatchSetSize": copy.deepcopy(self.aveMatchSetSize),
			"deletionVote": copy.deepcopy(self.deletionVote),
			"timeStampGA": copy.deepcopy(self.timeStampGA),
			"initTimeStamp": copy.deepcopy(self.initTimeStamp),
			"matchCount": copy.deepcopy(self.matchCount),
			"correctCount": copy.deepcopy(self.correctCount),
		}
		return copy.deepcopy(o)

	@staticmethod
	def fromGenericObject(o):
		a = o["special-condition"]
		a.append(o["phenotype"])		# phenotype
		a.append(o["fitness"])			# fitness
		a.append(o["accuracy"])			# accuracy
		a.append(o["numerosity"])		# numerosity
		a.append(o["aveMatchSetSize"])	# aveMatchSetSize
		a.append(o["timeStampGA"])		# timeStampGA
		a.append(o["initTimeStamp"])	# initTimeStamp
		a.append(0)						# (placeholder)
		a.append(0 if o["deletionVote"] == None else o["deletionVote"])		# deletionVote
		a.append(o["correctCount"])		# correctCount
		a.append(o["matchCount"])		# matchCount
		a.append(o["id"])
		return Classifier(a)
	...
	def rebootClassifier(self, classifierList): 
		...
		self.id = str(classifierList[numAttributes+11])
